<%-- 
    Document   : index
    Created on : Nov 20, 2016, 1:18:18 PM
    Author     : Nebojsa
--%>
...
<div id="wrapper">
  <div id="inner">
    <div id="header">
      ...
      <div id="nav"> <a href="/mavenproject1/">HOME</a> | <a href="cart">view cart</a> | <a href="http://www.free-css.com/">help</a> </div>
      <!-- end nav -->
    ...
    <dl id="browse">
      ...
      <c:forEach items="${genres}" var="genre">
          <dd><a href="/mavenproject1/${genre.id}">${genre.name}</a></dd>
      </c:forEach>          
