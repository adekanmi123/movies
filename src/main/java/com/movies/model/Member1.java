...
@NamedQueries({
    ...
    @NamedQuery(name = "Member1.find", query = "SELECT m FROM Member1 m WHERE m.firstName = :firstName AND m.lastName = :lastName AND m.address = :address AND m.city = :city AND m.postalCode = :postalCode AND m.email = :email"),
    ...
    @NamedQuery(name = "Member1.findByPostalCode", query = "SELECT m FROM Member1 m WHERE m.postalCode = :postalCode"),
...
public class Member1 implements Serializable {
    ...
    public String toString() {
        return "com.movies.model.Member1[ id=" + id + " ]";
    }
